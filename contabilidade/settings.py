...
ASAAS_CHECKOUT_PUBLIC_BASE_URL = os.getenv(
    "ASAAS_CHECKOUT_PUBLIC_BASE_URL",
    "https://asaas.com/checkoutSession/show?id=",
)
try:
    ASAAS_CHECKOUT_EXPIRATION_MINUTES = int(os.getenv("ASAAS_CHECKOUT_EXPIRATION_MINUTES", "100"))
except ValueError:
    ASAAS_CHECKOUT_EXPIRATION_MINUTES = 100
ASAAS_CHECKOUT_CALLBACK_BASE_URL = os.getenv("ASAAS_CHECKOUT_CALLBACK_BASE_URL", "").strip()
ASAAS_CHECKOUT_SUCCESS_URL = os.getenv("ASAAS_CHECKOUT_SUCCESS_URL", "").strip()
ASAAS_CHECKOUT_CANCEL_URL = os.getenv("ASAAS_CHECKOUT_CANCEL_URL", "").strip()
ASAAS_CHECKOUT_EXPIRED_URL = os.getenv("ASAAS_CHECKOUT_EXPIRED_URL", "").strip()
...
MACRO_AGENT_VERSION = os.getenv("MACRO_AGENT_VERSION", "2026.05.25-address-phone-fix").strip()
...
ORDERS_GROWTH_AGENT_VERSION = os.getenv("ORDERS_GROWTH_AGENT_VERSION", "2026.09.19-scroll-paciente").strip()
